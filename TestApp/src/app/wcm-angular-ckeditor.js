(function (root, factory) {
    ...
    angular
        .module('ckeditor', [])
        .directive('ckeditor', ['$parse', '$timeout', ckeditorDirective]);
    ...
    function ckeditorDirective($parse, $timeout) {
        return {
            restrict: 'A',
            require: ['ckeditor', 'ngModel', '^?form'],
            controller: [
                '$scope',
                '$element',
                '$attrs',
            ...
            link: function (scope, element, attrs, ctrls) {
                ...
                controller.ready().then(function initialize() {
                    ...
                    [ 'blur', 'change', 'saveSnapshot'].forEach(function (event) {
                        controller.onCKEvent(event, function syncView() {
                            ngModelController.$setViewValue(controller.instance.getData() || '');
